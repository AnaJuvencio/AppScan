...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicosHistoricoServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var HistoricoService = /*#__PURE__*/function () {
      ...
      _createClass(HistoricoService, [{
        key: "create",
        value: function create(historico) {
          return this.afs.collection('historicos').add(Object.assign({}, historico));
        ...
        key: "update",
        value: function update(key, historico) {
          return this.afs.doc("historicos/".concat(key)).update(historico);
        } // Delete - Deleta um elemento do histórico

      }, {
        key: "delete",
        value: function _delete(key) {
          return this.afs.doc("historicos/".concat(key))["delete"]();
        }
      }]);
    ...
    HistoricoService.ctorParameters = function () {
      return [{
        type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]
      }];
    };

    HistoricoService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], HistoricoService);
    /***/
  }
