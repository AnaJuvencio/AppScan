...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
  ...
  function srcAppTab1Tab1RoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Tab1PageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      providers: [_ionic_native_qr_scanner_ngx__WEBPACK_IMPORTED_MODULE_4__["QRScanner"]],
  ...
  function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab1Page = /*#__PURE__*/function () {
      function Tab1Page(platform, dialog, qr) {
        var _this = this;
        ...
        value: function startScanning() {
          ...
          this.qr.prepare().then(function (status) {
            if (status.authorized) {
              ...
              _this2.qrScan = _this2.qr.scan().subscribe(function (textFound) {
                document.getElementsByTagName("body")[0].style.opacity = "1";

                _this2.qrScan.unsubscribe();

                _this2.dialog.alert(textFound);
              }, function (err) {
                _this2.dialog.alert(JSON.stringify(err));
              });
